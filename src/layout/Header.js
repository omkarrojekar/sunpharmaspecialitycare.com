        ...
        <div className="topbar">
          <div className="topbar-left">
            <div className="text-center">
              <a href="/" className="logo"><img src={window.location.origin.toString()+"/assets/assets/images/users/favicon.jpg"} alt="" className="img img-responsive logo-img" /><span> AD<i className=""></i>MIN</span></a>
            </div>
          </div>
              ...
              <li className="list-inline-item dropdown notification-list">
                ...
                <div className="dropdown-menu dropdown-menu-right profile-dropdown " aria-labelledby="Preview">
                  <div className="dropdown-item noti-title">
                    <h5 className="text-overflow"><small>Welcome ! {localStorage.getItem("name")}</small> </h5>
                  </div>
                  <hr />
